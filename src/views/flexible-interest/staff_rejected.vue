    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
                <h3 class="text-left REJECTED"><strong>Rejected</strong></h3>
...
export default {
  ...
  methods: {
    ...
    getAllRejectedSearch(){
        ds.rpc.make('/bcel/api/flexible/interest/customer/requirement/by/staff/rejected/search', { staffUser:  this.$store.getters['flexible_interest_module/user'], searchData: this.search_data.trim()}, ( error, result ) => {
            if(error){
                this.aclasses = [];
            } else{
    ...
    getAllRejected(){
        ds.rpc.make('/bcel/api/flexible/interest/customer/requirement/by/staff/rejected', { staffUser:  this.$store.getters['flexible_interest_module/user']}, ( error, result ) => {
            if(error){
                this.aclasses = [];
            } else{
                this.customer_requirement_history = result;
