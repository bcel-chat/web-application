        ...
        <div class="container-fluid" id="fi_print">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <h3 class="fi-title text-center"><strong>ລາຍການທີ່ໄດ້ຮັບການອະນຸມັດປະຈຳວັນ</strong></h3>
                </div>
                <div class="col-12 col-sm-12 col-md-12">
...
export default {
    ...
    methods: {
        ...
        getData(){
            ...
            ds.rpc.make('/bcel/chat/api/flexible/interest/report/customer/requirement/approved/dialy', { 
               limited:  this.limit, 
            ...
            if(this.customer_requirments.length>0){
                import('@/vendor/Export2Excel').then(excel => {
                    ...
                    excel.export_json_to_excel({
                        header: tHeader,
                        data,
                        filename: 'report-interest-flexible-approved-dialy-'+this.getDate(this.choose_date).replace(/\//g,'-')+'-limit-'+this.limit,
                        autoWidth: true,
                        bookType: 'xlsx'
                    });
                });
