    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12">
                <h2 class="text-left PENDING"><strong>PENDING</strong></h2>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4" v-for="(history, index) in customer_requirement_history" :key="index">
...
export default {
  ...
  methods: {
    ...
    doSearch(){
       if(this.search_data.trim()) {
           this.getAllNewApproveRequestSearch();
       }
    },
    getAllNewApproveRequestSearch(){
        ds.rpc.make('/bcel/api/flexible/interest/leader/request/approve/new/search', { user:  this.$store.getters['flexible_interest_module/user'], searchData: this.search_data.trim()}, ( error, result ) => {
            if(error){
                this.aclasses = [];
            } else{
    ...
    getAllNewApproveRequest(){
        ds.rpc.make('/bcel/api/flexible/interest/leader/request/approve/new', { user:  this.$store.getters['flexible_interest_module/user']}, ( error, result ) => {
            if(error){
                this.aclasses = [];
            } else{
                this.customer_requirement_history = result;
    ...
    getCustomerRequirementDetail(history){
        ...
        console.log(btoa(history['requirementId']))
