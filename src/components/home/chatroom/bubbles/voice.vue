<template>
<div class="bb-wrapper mb-2"><span></span>
            <div class="bb-container _17oKL message-in">
                <div class="_2N_Df _3ylqw">
                    <div class="_2jfIu">
                        <div class="_2cfqh">
                        ...
                        <div class="_2fuJy">
                            <div class="_1WliW" style="height: 55px; width: 55px;">
                                <img :src="this.$store.state.chats.reciever.img" draggable="false" class="Qgzj8 gqwaM" style="visibility: visible;">
