<template>
    <div class="RLfQR">
        ...
        <div class="ntct">
            <!-- <transition tag="div" name="slide-list"> -->
            <div class="ntbx" v-for="noti in notify" :key="noti.index">
                <div class="ntic">
                    <div class="_1WliW" style="height: 35px; width: 35px; cursor: pointer;">
                        <img src="https://i.pinimg.com/originals/78/c9/ab/78c9ab1c457e53037972aefeb9bd13cc.jpg" draggable="false" class="Qgzj8 gqwaM" style="visibility: visible;">
                        <div class="_3ZW2E">
                ...
                <div class="dex">
                    <div class="natl">
                        ...
                        <div class="clsn">
                            <i class="material-icons ico">cancel</i>
                        </div>
                    </div>
                    <div class="hsds">
                        <div class="htjl">
                    ...
                    <div class="njgd">
                        <div class="msle">
                            <div class="wokl">
                                <a rolse="button" class="app">Approve</a>
                                <a rolse="button" class="eje">Eject</a>
                            </div>
                            <div class="tml">
                               <div class="fksj">
                                   10:50 AM
...
<script>
    export default{
        ...
        mounted(){
            setTimeout(()=>{
                this.notifytList = true
            }, 250)
        }
    }
</script>
<style lang="scss" scroped>
    @import '@/assets/scss/sidebar/sidebar.notify.scss';
