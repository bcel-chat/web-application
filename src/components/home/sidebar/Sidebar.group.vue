...
<div class="RLfQR">
        <transition tag="div" name="slide-list">
            <div class="ggd">
                <div class="ggdb" v-for="(grid, index) in grids" :key="index">
                    <div class="grx">
                        <div class="gbc">
                            <div class="_2umId">
                                <div class="_1WliW" style="height: 70px; width: 70px; cursor: pointer;">
...
@import "@/assets/scss/sidebar/sidebar.group.scss";
